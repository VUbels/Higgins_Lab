---
title: "Seurat_Cluster_Assignment"
author: "Victor Ubels"
date: "2023-11-01"
...
#print(stackedBarPlot(clustByDisease, namedColors=TRUE))
dev.off()
...
subwd <- paste0(output_directory, sprintf("Clustering_03/%s", subgroups[i]))
allGenes <- rownames(GetAssayData(object=readRDS(paste0(subwd, sprintf('/%s.rds', subgroups[i]))), slot="counts"))
...
# Iteratively cluster subgroups:
  ...
  plotClusterQC(obj, subgroup=subgroup, plotDir=plotDir, pointSize=pointSize, sampleCmap=sample_cmap, diseaseCmap=disease_cmap)
