...
Gene_Error_Log__Broad_file <- paste0(output_directory, "Clustering_02/Broad_UMAPs/Gene_Error_logging.txt")
...
for(name in names(featureSets_broad)) {
    ...
    for(gene in features) {
        tryCatch({
            ...
            write(error_message, file = Gene_Error_Log_file, append = TRUE)
        })
    }
    dev.off()
}
...
Gene_Error_Log_file <- paste0(output_directory, "Clustering_02/Specific_CellType_UMAPs/Gene_Error_logging.txt")
