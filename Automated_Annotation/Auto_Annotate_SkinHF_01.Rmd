...
for(i in seq_along(resolution)){
    ...
    seurat_obj_merged <- FindClusters(object = seurat_obj_merged, resolution = resolution[i])
...
output_filename_markers <- paste0(output_directory, "/Clustering_01/Markers_PreCluster", dataset, ".xlsx")
