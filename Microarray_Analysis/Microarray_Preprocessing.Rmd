...
# 
# BiocManager::install(c("gage", "gageData", "affy", "oligo", "oligoData", "statmod", "limma", "pdInfoBuilder", "affycoretools", "pd.clariom.s.human"))
```

```{r}
#If this is your first time running the script re initiate the renv environment
